    ...
    <form action="login.php" method="post" class="space-y-6"> <!-- Aumento do espaço vertical -->
        ...
        <!-- Botão Entrar -->
         <div class="flex justify-center w-50 pt-4 mx-auto"> 
            <button type="submit" 
                    class="adopt-btn-logar bg-[#b92b2b] text-[#f0e9e9] font-bold text-4xl py-2  w-full rounded-2xl shadow-lg hover:shadow-xl hover:scale-[1.01] transition-all duration-300 ease-in-out">
