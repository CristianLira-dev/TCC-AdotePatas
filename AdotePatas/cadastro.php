        ...
        if ($senha !== $confirma_senha) {
            ...
            try {
                ...
                if ($stmt->execute([
                    ...
                    $mensagem_status = "Cadastro realizado com sucesso! Você pode fazer login agora.";
                ...
                if ($e->getCode() == '23000') {
                    $mensagem_status = "Este e-mail ou CPF já está cadastrado.";
                } else {
...
<head>
    ...
    <title>Cadastro - Adote Patas</title>
...
@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital@0;1&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap');
        ...
        /* O select precisa ter 'appearance-none' no HTML para pegar o estilo customizado */
        .input-style.appearance-none {
            /* Se for select, garante que o texto fique na cor branca */
             color: white; 
        }
        .input-style.appearance-none option {
            /* Fundo branco para opções dentro do select */
...
<img src="images/cadastro-login/pata.png" alt="Desenho de Pata" 
     class="pata-fundo">

     <div class="text-center pt-2 cadastro-ong-link">
            <a href="cadastro_ong.php" class="text-base text-[#980403] hover:text-[#b34848] font-semibold border-b border-[#980403] hover:border-[#980403] transition duration-300">
                Cadastrar como ONG
            </a>
        </div>
      <!-- Logo e Título -->
    <div class="w-full flex items-center justify-between mb-8 relative">
        ...
        <div> 
            <img src="images/global/Logo-AdotePatas.png" alt="Logo Adote Patas" class="h-30 w-40">
        </div>
...
<div class="container-card w-full max-w-md p-10 rounded-3xl shadow-xl">
    ...
    <form action="cadastro.php" method="post" class="space-y-6"> 
        ...
        <!-- Botão Cadastrar (LARGURA TOTAL E ESTILO LOGIN) -->
         <div class="flex justify-center w-full pt-4"> 
            <button type="submit" 
                    class="adopt-btn-logar bg-[#b92b2b] text-[#f0e9e9] font-bold text-2xl py-3 w-full rounded-2xl shadow-lg hover:shadow-xl hover:scale-[1.01] transition-all duration-300 ease-in-out">
                <div class="heart-background" style="user-select: none;">❤</div>
                <span class="text-shadow">Cadastrar</span>
            </button>
        </div>
        
        <!-- Link para Criar conta ONG -->
    ...
    <div class="text-center mt-6">
        <a href="login.php" class="text-base text-[#980403] hover:text-[#b34848] font-semibold border-b border-[#980403] hover:border-[#980403] transition duration-300">
