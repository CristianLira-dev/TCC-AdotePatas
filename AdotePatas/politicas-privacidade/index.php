...
ob_start();
require dirname(__DIR__) . '/politicas-privacidade.php';
$html = ob_get_clean();

$baseUrl = ADOTE_PATAS_BASE_URL;
$homeUrl = htmlspecialchars($baseUrl, ENT_QUOTES, 'UTF-8');
$termsUrl = htmlspecialchars($baseUrl . 'termos-de-uso/', ENT_QUOTES, 'UTF-8');
...
$crossLink = '<p class="mt-3 mb-0"><a href="' . $termsUrl . '" class="text-decoration-underline">Ler também os Termos de Uso</a></p>';
$html = str_replace(
